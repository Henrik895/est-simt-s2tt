...
# This should now point to the folder, where the finetuned NLLB model is located
NLLB_CHECKPOINT = "fine_tuned_checkpoint"
...
class NLLBAgent(TextToTextAgent):
    ...
    def policy(self, states: Optional[NLLBStates] = None):
        ...
        # Local Agreement matching
        if not states.source_finished:
            confirmed = [] # Words that will go to the output
